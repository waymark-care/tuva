...
select
    ...
    cast(tuva_last_run as {{ dbt.type_string() }}) as tuva_last_run,
    dense_rank() over (
        order by data_source, table_name, claim_type, field_name
    ) as summary_sk
from unioned_cte
